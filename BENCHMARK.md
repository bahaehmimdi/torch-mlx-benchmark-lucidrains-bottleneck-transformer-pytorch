...
**torch-mlx** est une reimplémentation de l'API PyTorch basée sur le moteur **MLX
d'Apple Silicon**. L'architecture de **lucidrains/bottleneck-transformer-pytorch** a été testée de manière **non modifiée**.
